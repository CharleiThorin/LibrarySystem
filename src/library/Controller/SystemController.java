...
public class SystemController implements Initializable {
    ...
    @FXML
    private TableView<LibraryMember> memeber_table;
    ...
    @FXML
    private TableColumn<LibraryMember, String> col_street;
    @FXML
    private TableColumn<LibraryMember, String> col_city;
    @FXML
    private TableColumn<LibraryMember, String> col_zipCode;
...
//    }
    ...
    public void initMemberCols() {
        col_fname.setCellValueFactory(new PropertyValueFactory<>("first Name"));
        col_lname.setCellValueFactory(new PropertyValueFactory<>("last Name"));
    ...
    public void editMemberCols() {
        ...
        col_street.setOnEditCommit(e -> {
            e.getTableView().getItems().get(e.getTablePosition().getRow()).setStreet(e.getNewValue());
        });
        ...
        col_zipCode.setCellFactory(TextFieldTableCell.forTableColumn());
        col_zipCode.setOnEditCommit(e -> {
...
//    }
    ...
    void add(ActionEvent event) {
        ...
        if (combo.getValue().equals("Books")) {
            ...
            text.setStyle("-fx-font-family: Calibri;" +
                    "-fx-font-weight: BOLD;" +
                    "-fx-font-size: 40");
            ...
            buttonBook.setStyle("-fx-background-radius: 5.0;" +
...
//        StackPane stackPane1 = new StackPane();
            ...
            JFXTextField street = new JFXTextField();
            street.setPromptText("Street");
            street.setLabelFloat(true);

            JFXTextField city = new JFXTextField();
            city.setPromptText("City");
            city.setLabelFloat(true);

            JFXTextField zipCode = new JFXTextField();
            ...
            vBox.setMinWidth(300);
            vBox.setSpacing(10);
            vBox.getChildren().addAll(lastName, phone, zipCode);

            buttonMember.setStyle("-fx-background-radius: 5.0;" +
                    "-fx-background-color: BLUE;" +
                    "-fx-font-weight: 20.0;" +
                    "-fx-text-fill: white");
...
//        if (combo.getValue().equals("Books")) {
        ...
        dataAccess.addMember(new LibraryMember("Brook", "Yemerou", "641-111-1111", new Address("1000N 4th street", "FairField", 52556)));
        List<String> memberNames = new ArrayList<>();
        for (LibraryMember member : dataAccess.getMembers()) {
        ...
        button.setStyle("-fx-background-radius: 5.0;" +
                "-fx-background-color: BLUE;" +
                "-fx-font-weight: 20.0;" +
                "-fx-text-fill: white");
...
//        StackPane stackPane1 = new StackPane();
        ...
        button.setOnAction(e -> {
            ...
            LibraryMember m = dataAccess.getmember(name);
    ...
    public void checkOut(Book b, LibraryMember m) {
    ...
    public  void refreshMemberTable() {
        LibraryMember m = dataAccess.getMembers().get(0);
        System.out.println(m.getFullName() + ":" + m.getAddress());
        members = FXCollections.observableArrayList(dataAccess.getMembers());
        memeber_table.setItems(members);
    }
